...
int adjacent_list[3201][6], adjacent_list_count[3201], occupied[3201];
bool visited[3201];
...
int main(void)
{
	...
	while(C--)
	{
		int N, M, id[80][80], odd_count=1, even_count=1, odd_matched=0, even_matched=0;
		char seat[80][81]={0};
		...
		memset(adjacent_list_count,0,3201*sizeof(int));
		memset(occupied,0,3201*sizeof(int));
