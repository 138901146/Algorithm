...
int main(void)
{
	int Y, X, **board=NULL, *empty_queue=NULL, *cheese_queue=NULL, move[4][2]={{-1,0},{0,-1},{0,1},{1,0}}, cheese=0, empty_rear=0, empty_front, cheese_rear, melt, count=0;
	...
	while(cheese>0)
	{
		empty_front=cheese_rear=melt=0;
